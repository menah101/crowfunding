...
const CampaignViewAuth = () => {
  return (
    <div className="flex items-center gap-x-5 mb-9">
      <img src={defaultImage} alt="" className="w-[60px] h-[60px] rounded-full" />
      <div className="flex-1 flex flex-col">
        <div className="flex items-center gap-x-4">
          <h3 className="text-lg font-medium">VanQuy</h3>
...
export default CampaignViewAuth;
