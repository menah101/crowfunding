...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      <div className="flex items-center bg-white rounded-full shadow-[10px_10px_20px_rgba(128,_213,_213,_0.15)] p-2 w-full ">
        <div className="flex-1 px-5">
          <input
            type="text"
            placeholder="Do fundrise now"
            className="text-sm bg-transparent placeholder:text-text4 text-text1 w-full"
          />
        </div>
      ...
      {showSearch && (
        <div className="search-results w-full lg:w-[843px] bg-white absolute top-full left-0 z-50 translate-y-5 pb-6 rounded-3xl">
          <div className="flex items-center justify-between p-3 bg-graySoft rounded-3xl">
            <h4 className="text-sm font-semibold pl-4 underline">See all 10.124</h4>
